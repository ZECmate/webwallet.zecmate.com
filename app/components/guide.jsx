      ...
      <Container>      
        <Row>
          <Col>                          
            ...
            <ul>
              <li><span className="guide1b">Go to</span> <a href="https://webwallet.zecmate.com">https://webwallet.zecmate.com</a></li>
            ...
            <ul>
              <li><span className="guide2b">If you've created a wallet on</span> <a href="https://webwallet.zecmate.com">https://webwallet.zecmate.com</a> <span className="guide2c">via the secret phrase, simply re-enter the same phrase.</span></li>
            ...
            <h3><span className="guide2a">3. Using Copay</span></h3>
            <ul>
              <li><span className="guide2b">Copay uses BIP44 wallet derivation paths.</span></li>
            </ul>
          </Col>
        </Row>
      </Container>
